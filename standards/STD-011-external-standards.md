...
| CAO | ISO/IEC 42001 · AI management | <https://www.iso.org/standard/42001> | 3 | — | `STD-005` AGT-06 asks by hand for part of it |
...
| Platform | Conventional Commits | <https://www.conventionalcommits.org/> | 1 | `STD-005` ARC-006 | declared `[AUTO: commitlint]`; no commitlint in the tree (`DBT-020`) |
...
| Platform | Gherkin / BDD | <https://cucumber.io/docs/gherkin/> | 0 | `numinia-web`: ten `.feature` files, `test:acceptance` in CI | software only; a governance document has no scenarios (`STD-005` AGT-05) |
| Product | WCAG 2.2 AA | <https://www.w3.org/TR/WCAG22/> | 0 | `numinia-web`: `apps/store/e2e/a11y.spec.ts`, axe + Playwright, 31 routes, both themes | `STD-005` ARC-010 still says "coverage incomplete" and points at a path that does not exist here |

...
- head: `1a560b5`  · corpus_hash: `274145b5424ce161…`  · measured_at: 2026-09-11T06:10:41Z  · root_dirty: 1
...
| `corpus.scripts_total` | 35 | files | files under `scripts/` with a code extension (.py .mjs .js .sh .ts) |
...
| `tokens.total` | 267458 | tokens | Σ tokens over the corpus (every tracked .md outside web/, whole file, frontmatter included) |
| `tokens.by_dir` | (table below) | tokens | tokens per top-level dir, largest first |
| `tokens.by_status` | (table below) | tokens | tokens per frontmatter status ((none) = no status), largest first |
| `tokens.missions_share_pct` | 16.1 | percent | 100·tokens(missions/)/total, rounded to 0.01 |

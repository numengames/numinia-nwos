...
- head: `6ff8a50`  · corpus_hash: `0cf52447fc655b65…`  · measured_at: 2026-09-09T10:20:53Z  · root_dirty: 0
...
| `tokens.total` | 292896 | tokens | Σ tokens over the corpus (every tracked .md outside web/, whole file, frontmatter included) |
| `tokens.by_dir` | (table below) | tokens | tokens per top-level dir, largest first |
| `tokens.by_status` | (table below) | tokens | tokens per frontmatter status ((none) = no status), largest first |
| `tokens.missions_share_pct` | 17.8 | percent | 100·tokens(missions/)/total, rounded to 0.01 |

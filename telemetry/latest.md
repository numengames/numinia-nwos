...
- head: `6d9757d`  · corpus_hash: `24660193fed5781f…`  · measured_at: 2026-09-09T12:38:34Z  · root_dirty: 0
...
| `tokens.total` | 268607 | tokens | Σ tokens over the corpus (every tracked .md outside web/, whole file, frontmatter included) |
...
| `legacy.referencias_textuales_total` | 1343 | mentions | occurrences of `(MIS\|ADR\|DEC\|RPT\|AUD\|P\|C\|BP)-<1..4 digits>` at word boundaries in the full text of docs_total (frontmatter included) |

...
- head: `8a04614`  · corpus_hash: `09a180da3d3c02fa…`  · measured_at: 2026-09-09T11:33:58Z  · root_dirty: 0
...
| `tokens.total` | 281247 | tokens | Σ tokens over the corpus (every tracked .md outside web/, whole file, frontmatter included) |
| `tokens.by_dir` | (table below) | tokens | tokens per top-level dir, largest first |
| `tokens.by_status` | (table below) | tokens | tokens per frontmatter status ((none) = no status), largest first |
| `tokens.missions_share_pct` | 15.3 | percent | 100·tokens(missions/)/total, rounded to 0.01 |

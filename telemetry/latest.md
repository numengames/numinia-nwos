...
> **Summary:** The only document in this corpus that states figures. Generated by `scripts/telemetry.mjs v0.3.0`; every number below names its unit and predicate.
...
- head: `19c5b96+index`  · corpus_hash: `8343da640ae46957…`  · measured_at: 2026-09-02T15:22:24Z  · root_dirty: 0
...
| `corpus.scripts_total` | 67 | files | files under `scripts/` with a code extension (.py .mjs .js .sh .ts) |
...
| `tokens.total` | 602230 | tokens | Σ tokens over the corpus (every tracked .md outside web/, whole file, frontmatter included) |
| `tokens.by_dir` | (table below) | tokens | tokens per top-level dir, largest first |
| `tokens.by_status` | (table below) | tokens | tokens per frontmatter status ((none) = no status), largest first |
| `tokens.missions_share_pct` | 39.2 | percent | 100·tokens(missions/)/total, rounded to 0.01 |
...
| | 0 | 1 |
|---|---|---|
| 0 | standards/2026_08_18-Sistema_de_Diseno-v5.1.0.md | 45633 |
| 1 | standards/STD-001-glossary.md | 21516 |
| 2 | reports/RPT-011-licensing-c005.md | 12537 |
| 3 | canon/CAN-002-brand-and-culture.md | 11817 |
| 4 | missions/MIS-0125-prefix-register.md | 10084 |
...
| `legacy.referencias_textuales_total` | 2941 | mentions | occurrences of `(MIS\|ADR\|DEC\|RPT\|AUD\|P\|C\|BP)-<1..4 digits>` at word boundaries in the full text of docs_total (frontmatter included) |

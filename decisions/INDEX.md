...
| DEC-005 | pablofm.com as public CAO portal | ⬛ Superseded — numinia.org is the surface | 2026-04-03 |
| DEC-006 | English as official NWOS repo language | ⬛ Superseded by ADR-024 | 2026-04-07 |
...
- v1.10.0 (2026-08-30) — Five DEC retired as superseded with one-line succession banners: DEC-002→C-005, DEC-006→ADR-024, DEC-001/003/005 overtaken by practice (Workers deploy, no ratification, numinia.org). DEC-004 stays active — hybrid agent architecture still describes reality. Texts intact (P-010 §5).
- v1.9.0 (2026-08-30) — ADR-031 registered: LEGAL_DEBT/DEUDA-404 dissolve into debt/ (LD→D-042..046, 404→D-040/041), GAPS frozen to reports/, C-005 §5 amended to v1.3.0 by formal consensus.

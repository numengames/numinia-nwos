...
- guards: lint-naming treats `type: meta` as apparatus (D-014, as count-evidence already did) — naming-baseline 2 → 0; references-baseline 671 → 669; url-baseline 622 → 624. count-evidence missions 132/132 · 100 %.

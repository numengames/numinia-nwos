...
started: null
completed: null
freeze_reason: "waiting on hardware delivery — the PC in transit; unfreeze when it exists"
...
- v1.3.0 (2026-09-02) — status todo → frozen (a todo that cannot start is frozen by STD-001 §7's own definition — waiting on hardware delivery). Proposed in #199 on the 2026-09-02 status check; the Oracle signs by merging (PRO-003 §2).

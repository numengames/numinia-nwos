...
| D5 | Three naming conventions coexisting (IDs, dated, free names with spaces: `CAN-001-welcome-to-numinia.md`, `CAN-002-brand-and-culture.md`…) | Batch rename per P-010 §3, with a mapping record and redirects where URLs change. **canon/ closed by ADR-036 (2026-09-01)**: the whole folder is `CAN-NNN` now |

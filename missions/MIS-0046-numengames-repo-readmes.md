...
- v1.3.0 (2026-09-02) — status todo → frozen (superseded by MIS-103, which inventories every org repository from the API — its three named repos included by construction). Proposed in #199 on the 2026-09-02 status check; the Oracle signs by merging (PRO-003 §2).

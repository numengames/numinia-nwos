...
- v1.3.0 (2026-09-02) — status todo → frozen (obsolete target — the pablofm.com page does not exist; booking from numinia.com is a new brief, the mechanism (Cal.com) a one-line change). Proposed in #199 on the 2026-09-02 status check; the Oracle signs by merging (PRO-003 §2).
...
| — | [#157](https://github.com/numengames/numinia-nwos/pull/157) (merged) | *Not a reduction PR* — MIS-125 Stage B pre-work: D-008 v2.1.0 (`history/2026_09_08-Superseded_Constitution-v2.0.0.md` excluded as apparatus, `debt/D-001` extinguishment recount) | 0 files (content edits only) | not measured — not a reduction PR |

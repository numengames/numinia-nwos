...
| 7 | B | `debt/DBT-001-series-prefixes-not-applied.md` L40, L222 | *"missions/ MIS-NNNN 0/131"* and *"131 files … last"*. 132/132 · 100 % by `count-evidence.py` as of #198 (apparatus excluded). The entry's premise is closed for 10 of 11 series; `infra/` has 0 files. | `count-evidence.py` | Close DBT-001 under ADR-030 (operational debt extinguishes on close) or reduce it to the one open series. |
